...
1. **Testleri Çalıştır**: Test komutunu projenin `AGENTS.md`'sinden veya README'sinden öğren ve Terminal'de çalıştır (örn. iOS: `xcodebuild test` / Android: `./gradlew test` / Node: `npm test`).
